...
const MENU_ITEMS = [
  { key: 'dashboard', route: 'AdminDashboard', label: 'Dashboard', icon: 'view-dashboard-outline' },
  { key: 'profile', route: 'AdminProfile', label: 'Profile', icon: 'account-circle-outline' },
];

export default function AdminSidebarMenu({ isOpen, onClose, navigation, activeRoute }) {
